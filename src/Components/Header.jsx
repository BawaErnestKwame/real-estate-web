...
const Header = () => {
  return (
    ...
    w-full overflow-hidden'  style={{ backgroundImage: `url(${headerImg})` }}>
    <Navbar/>

    <div className='container text-center mx-auto py-4 px-6 md:px-20 lg:px-32 text-white'>
        <h2 className='text-5xl pb-4 font-bold sm:text-6xl md:text-[82px] inline-block max-w-3xl font-semibold '>Explore homes that fit your dreams </h2>
